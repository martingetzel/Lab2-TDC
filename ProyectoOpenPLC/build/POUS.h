...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,AND91_OUT)
  __DECLARE_VAR(BOOL,NOT86_OUT)
  __DECLARE_VAR(BOOL,NOT93_OUT)
  __DECLARE_VAR(BOOL,AND35_OUT)
  __DECLARE_VAR(BOOL,NOT14_OUT)
  __DECLARE_VAR(BOOL,AND83_OUT)
  __DECLARE_VAR(BOOL,NOT79_OUT)
  __DECLARE_VAR(BOOL,NOT85_OUT)
  __DECLARE_VAR(BOOL,AND58_OUT)
